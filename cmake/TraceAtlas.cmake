...
function(InjectMemory tar)
 ...
 -Memory $<TARGET_FILE:${tar}> -o ${tar}.memory.bc
    ...
    get_target_property(TARGET_LINKS ${tar} LINK_LIBRARIES)
    target_link_libraries(${tar}-memory-trace PRIVATE AtlasBackend ${PAPI_LIBRARIES} ${TARGET_LINKS})
endfunction()
...
-Instance $<TARGET_FILE:${tar}> -o instance.bc
    ...
    get_target_property(TARGET_LINKS ${tar} LINK_LIBRARIES)
    target_link_libraries(${tar}-instance-trace PRIVATE AtlasBackend ${PAPI_LIBRARIES} ${TARGET_LINKS})
endfunction()
...
function(MemProfiler tar)
    ...
    get_target_property(TARGET_LINKS ${tar} LINK_LIBRARIES)
    target_link_libraries(${tar}-memProfile PRIVATE AtlasBackend ${PAPI_LIBRARIES} ${TARGET_LINKS})
endfunction()
...
function(LoopDetection tar)
    ...
    get_target_property(TARGET_LINKS ${tar} LINK_LIBRARIES)
    target_link_libraries(${tar}-CFG PRIVATE AtlasBackend ${PAPI_LIBRARIES} ${TARGET_LINKS})
endfunction()
...
function(InjectLastWriter tar)
 ...
 -LastWriter $<TARGET_FILE:${tar}> -o LastWriter.bc
    ...
    get_target_property(TARGET_LINKS ${tar} LINK_LIBRARIES)
    target_link_libraries(${tar}-LastWriter-trace PRIVATE AtlasBackend ${PAPI_LIBRARIES} ${TARGET_LINKS})
endfunction()
