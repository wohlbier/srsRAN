# jgw
add_library(AtlasPasses PROPERTIES IMPORTED)
set_target_properties(AtlasPasses PROPERTIES IMPORTED_LOCATION /home/TraceAtlas/lib/AtlasPasses.so)
...
function(InjectTracer tar)
 ...
 DEPENDS $<TARGET_FILE:${tar}>
    ...
    set_target_properties(${tar}-trace PROPERTIES LINK_FLAGS "-L${PAPI_PREFIX}/lib -lpapi")
...
function(InjectMemory tar)
 ...
 -Memory $<TARGET_FILE:${tar}> -o ${tar}.memory.bc
    ...
    set_target_properties(${tar}-memory-trace PROPERTIES LINK_FLAGS "-L${PAPI_PREFIX}/lib -lpapi")
    target_link_libraries(${tar}-memory-trace PRIVATE AtlasBackend)
endfunction()
...
-Instance $<TARGET_FILE:${tar}> -o instance.bc
    ...
    set_target_properties(${tar}-instance-trace PROPERTIES LINK_FLAGS "-L${PAPI_PREFIX}/lib -lpapi")
    target_link_libraries(${tar}-instance-trace PRIVATE AtlasBackend)
endfunction()
...
function(MemProfiler tar)
    ...
    set_target_properties(${tar}-memProfile PROPERTIES LINK_FLAGS "-L${PAPI_PREFIX}/lib -lpapi")
    target_link_libraries(${tar}-memProfile PRIVATE AtlasBackend)
endfunction()
...
function(LoopDetection tar)
    ...
    set_target_properties(${tar}-CFG PROPERTIES LINK_FLAGS "-L${PAPI_PREFIX}/lib -lpapi")
    target_link_libraries(${tar}-CFG PRIVATE AtlasBackend)
endfunction()
...
function(InjectLastWriter tar)
 ...
 -LastWriter $<TARGET_FILE:${tar}> -o LastWriter.bc
    ...
    set_target_properties(${tar}-LastWriter-trace PROPERTIES LINK_FLAGS "-L${PAPI_PREFIX}/lib -lpapi")
    target_link_libraries(${tar}-LastWriter-trace PRIVATE AtlasBackend)
endfunction()
